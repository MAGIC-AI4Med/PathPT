...
from wsi_selecters.wsi_selecter_KEEP import patch_selector, wsi_prompt_selector
import json
from torch.cuda.amp import autocast, GradScaler
from loss import balanced_ce_loss, PatchSSLoss
...
def model_init(cfg, classnames_list, keep_model, keep_tokenizer, device, param, vfeat_dim):
    model = PPTKEEP(cfg, classnames_list, keep_model, keep_tokenizer, device, param, vfeat_dim)
